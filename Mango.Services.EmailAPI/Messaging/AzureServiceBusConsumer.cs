...
public class AzureServiceBusConsumer:IAzureServiceBusConsumer
{
    ...
    public AzureServiceBusConsumer(IConfiguration configuration, EmailService emailSender)
    {
        ...
        orderCreated_Topic = _configuration.GetValue<string>("TopicAndQueuNames:OrderCreatedTopic");
        orderCreated_Email_Subscription = _configuration.GetValue<string>("TopicAndQueuNames:OrderCreated_Email_Subscription");
