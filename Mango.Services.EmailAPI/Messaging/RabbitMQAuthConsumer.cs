...
public class RabbitMQAuthConsumer : BackgroundService
{
    ...
    public RabbitMQAuthConsumer(IConfiguration configuration, EmailService emailService)
    {
        ...
        _channel.QueueDeclare(_configuration.GetValue<string>("TopicAndQueuNames:RegisterUserQueue"),
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _channel.BasicConsume(_configuration.GetValue<string>("TopicAndQueuNames:RegisterUserQueue"), false, consumer);
