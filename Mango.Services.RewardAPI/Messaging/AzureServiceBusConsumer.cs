...
public class AzureServiceBusConsumer:IAzureServiceBusConsumer
{
    ...
    public AzureServiceBusConsumer(IConfiguration configuration, RewardService rewardService)
    {
        ...
        orderCreatedTopic = _configuration.GetValue<string>("TopicAndQueuNames:OrderCreatedTopic");
        orderCreatedRewardSubscription = _configuration.GetValue<string>("TopicAndQueuNames:OrderCreated_Rewards_Subscription");
