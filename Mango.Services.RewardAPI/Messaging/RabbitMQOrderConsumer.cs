...
public class RabbitMQOrderConsumer : BackgroundService
{
    ...
    public RabbitMQOrderConsumer(IConfiguration configuration, RewardService rewardService)
    {
       ...
       _rewardService = rewardService;
        ...
        _channel.ExchangeDeclare(_configuration.GetValue<string>("TopicAndQueuNames:OrderCreatedTopic"), ExchangeType.Fanout);
        queueName = _channel.QueueDeclare().QueueName;
        _channel.QueueBind(queueName, _configuration.GetValue<string>("TopicAndQueuNames:OrderCreatedTopic"), "");
    }
